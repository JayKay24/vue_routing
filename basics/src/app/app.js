  ...
  template: `
    <div>
      ...
      <p class="movies__description">
        Miraculous evacuation of Allied soldiers from
...
const InterstellarBlurb = {
  ...
  template: `
    <div>
      <h2>Interstellar</h2>
      <p class="movies__description">
        Interstellar chronicles the adventures of a
...
const TheDarkKnightRisesBlurb = {
  ...
  template: `
    <div>
      ...
      <p class="movies__description">
        Batman encounters the mysterious Selina Kyle
...
const View = {
  ...
  created() {
    if (this.getRouteObject() === undefined) {
      this.currentView = {
        template: `
          <h2>Not Found :(. Pick a movie from the list!</h2>
        `
      }
    } else {
